#ifndef __rrlib__aspect_maps_memory__phaseCorrelation_cu__
#define __rrlib__aspect_maps_memory__phaseCorrelation_cu__

#include "projects/aspect_maps_memory/gpu_algorithms/basicReductions.cu"
