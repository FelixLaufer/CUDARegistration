...
//
//----------------------------------------------------------------------
/*!\file    projects/aspect_maps_memory/gpu_algorithms/basicComplexMath.cu
 *
 * \author  Felix Laufer
 *
 * \date    2014-10-10
 ...
 *
 */
#ifndef __rrlib__aspect_maps_memory__basicComplexMath_cu__
#define __rrlib__aspect_maps_memory__basicComplexMath_cu__
