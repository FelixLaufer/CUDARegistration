...
//
//----------------------------------------------------------------------
/*!\file    projects/aspect_maps_memory/gpu_algorithms/basicReductions.cu
 *
 * \author  Felix Laufer
 *
 * \date    2014-10-10
 ...
 *
 */
#ifndef __rrlib__aspect_maps_memory__basicReductions_cu__
#define __rrlib__aspect_maps_memory__basicReductions_cu__
